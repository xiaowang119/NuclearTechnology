...
public class ReaderView
	...
	private static final int  MOVING_DIAGONALLY = 0;	//¶Ô½ÇÒÆ¶¯±àºÅ
	private static final int  MOVING_LEFT       = 1;	//×óÒÆ±àºÅ
	private static final int  MOVING_RIGHT      = 2;	//ÓÒÒÆ±àºÅ
	private static final int  MOVING_UP         = 3;	//ÉÏÒÆ±àºÅ
	private static final int  MOVING_DOWN       = 4;	//ÏÂÒÆ±àºÅ

	private static final int  FLING_MARGIN      = 100;	//±ßÔµÏÞÖµ
	private static final int  GAP               = 20;		//¼ä¾à

	private static final float MIN_SCALE        = 1.0f;	//×îÐ¡±ÈÀý
	private static final float MAX_SCALE        = 5.0f;	//×î´ó±ÈÀý
	...
	private boolean           mScaling;    // Whether the user is currently pinch zooming<Ëõ·Å>
